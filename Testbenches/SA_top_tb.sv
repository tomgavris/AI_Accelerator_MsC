...
/* this testbench is meant to handle activations with a 
time domain skew, simulating real life activation streaming
*/
module SA_top_tb ();
        ...
        for (int j = 0; j < N; j++) begin
            for (int k = 0; k < N; k++) begin
                for (int l = 0; l < OP ; l++) begin
                    top_w_i[i][j][k][l] = weight_val; // TODO: make the weights roll
